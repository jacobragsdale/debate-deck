...
if (theme.palette.type === "light") {
  //light mode shadows
  var myInsetBoxShadow =
    "inset 2px 2px 5px #999999, inset -2px -2px 5px #ffffff";
  var mySearchBackground = "linear-gradient(145deg, #e1e1e1, #ffffff)";
  var myBoxShadow = "5px 5px 10px #999999, -5px -5px 10px #ffffff";
  var myInsetSearchShadow =
    "inset 2px 2px 5px #999999, inset -2px -2px 4px #ffffff";
  var myHoverSearchShadow =
    "inset 4px 4px 8px #999999, inset -4px -4px 8px #ffffff";
} else {
  //dark mode shadows
  var myInsetBoxShadow =
    "inset 2px 2px 5px #282828, inset -2px -2px 5px #5c5c5c";
  var mySearchBackground = "linear-gradient(145deg, #3b3b3b, #474747)";
  var myBoxShadow = "5px 5px 10px #282828, -5px -5px 10px #5c5c5c";
  var myInsetSearchShadow =
      ...
      <AppBar className={classes.appBar}>
        <Toolbar className={classes.toolBar}>
          <div className={classes.iconSection}>
            <IconButton href="/dashboard" className={classes.cardIcon}>
              <CardIcon />
            </IconButton>
            <Hidden xsDown>
              <Typography
